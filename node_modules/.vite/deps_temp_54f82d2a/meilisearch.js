...
var MeiliSearchApiError = class extends MeiliSearchError {
  constructor(response, responseBody) {
    super(
      (responseBody == null ? void 0 : responseBody.message) ?? `${response.status}: ${response.statusText}`
    );
...
var MeiliSearchRequestTimeOutError = class extends MeiliSearchError {
  constructor(timeout, requestInit) {
    ...
    __publicField(this, "name", "MeiliSearchRequestTimeOutError");
    __publicField(this, "cause");
...
var MeiliSearchTaskTimeOutError = class extends MeiliSearchError {
  constructor(taskUid, timeout) {
    ...
    __publicField(this, "name", "MeiliSearchTaskTimeOutError");
    __publicField(this, "cause");
...
var _url, _requestInit, _customRequestFn, _requestTimeout, _HttpRequests_instances, getHeaders_fn, prepareRequest_fn, request_fn, requestStream_fn;
var HttpRequests = class {
  constructor(config) {
    __privateAdd(this, _HttpRequests_instances);
    __privateAdd(this, _url);
    __privateAdd(this, _requestInit);
    __privateAdd(this, _customRequestFn);
    __privateAdd(this, _requestTimeout);
    var _a;
    const host = addTrailingSlash(addProtocolIfNotPresent(config.host));
    try {
      __privateSet(this, _url, new URL(host));
    } catch (error) {
      throw new MeiliSearchError("The provided host is not valid", {
        cause: error
      });
    }
    __privateSet(this, _requestInit, {
      ...config.requestInit,
      headers: getHeaders(config, (_a = config.requestInit) == null ? void 0 : _a.headers)
    });
    __privateSet(this, _customRequestFn, config.httpClient);
    __privateSet(this, _requestTimeout, config.timeout);
  }
  /** Request with GET. */
  get(options) {
    return __privateMethod(this, _HttpRequests_instances, request_fn).call(this, options);
  }
  /** Request with POST. */
  post(options) {
    return __privateMethod(this, _HttpRequests_instances, request_fn).call(this, { ...options, method: "POST" });
  }
  /** Request with PUT. */
  put(options) {
    return __privateMethod(this, _HttpRequests_instances, request_fn).call(this, { ...options, method: "PUT" });
  }
  /** Request with PATCH. */
  patch(options) {
    return __privateMethod(this, _HttpRequests_instances, request_fn).call(this, { ...options, method: "PATCH" });
  }
  /** Request with DELETE. */
  delete(options) {
    return __privateMethod(this, _HttpRequests_instances, request_fn).call(this, { ...options, method: "DELETE" });
  }
  /** Request with POST that returns a stream. */
  postStream(options) {
    return __privateMethod(this, _HttpRequests_instances, requestStream_fn).call(this, { ...options, method: "POST" });
  }
};
_url = new WeakMap();
_requestInit = new WeakMap();
_customRequestFn = new WeakMap();
_requestTimeout = new WeakMap();
_HttpRequests_instances = new WeakSet();
/**
 ...
 */
getHeaders_fn = function(extraHeaders, contentType) {
  if (extraHeaders === void 0 && contentType === void 0) {
    return __privateGet(this, _requestInit).headers;
  }
  const headers = new Headers(extraHeaders);
  if (contentType !== void 0 && !headers.has("Content-Type")) {
    headers.set("Content-Type", contentType);
  }
  for (const [key, val] of __privateGet(this, _requestInit).headers) {
    if (!headers.has(key)) {
      headers.set(key, val);
    }
  }
...
prepareRequest_fn = function({
  ...
  const url = new URL(path, __privateGet(this, _url));
  if (params !== void 0) {
  ...
  const init = {
    ...
    ...extraRequestInit,
    ...__privateGet(this, _requestInit),
    headers: __privateMethod(this, _HttpRequests_instances, getHeaders_fn).call(this, extraRequestInit == null ? void 0 : extraRequestInit.headers, contentType)
  };
  return { url, init };
};
request_fn = async function(options) {
  const { url, init } = __privateMethod(this, _HttpRequests_instances, prepareRequest_fn).call(this, options);
  const startTimeout = __privateGet(this, _requestTimeout) !== void 0 ? getTimeoutFn(init, __privateGet(this, _requestTimeout)) : null;
  const stopTimeout = startTimeout == null ? void 0 : startTimeout();
  let response;
  let responseBody;
  try {
    if (__privateGet(this, _customRequestFn) !== void 0) {
      return await __privateGet(this, _customRequestFn).call(this, url, init);
    }
    ...
    throw new MeiliSearchRequestError(
      url.toString(),
      Object.is(error, TIMEOUT_ID$1) ? new MeiliSearchRequestTimeOutError(__privateGet(this, _requestTimeout), init) : error
    );
  } finally {
    stopTimeout == null ? void 0 : stopTimeout();
  }
...
requestStream_fn = async function(options) {
  const { url, init } = __privateMethod(this, _HttpRequests_instances, prepareRequest_fn).call(this, options);
  const startTimeout = __privateGet(this, _requestTimeout) !== void 0 ? getTimeoutFn(init, __privateGet(this, _requestTimeout)) : null;
  const stopTimeout = startTimeout == null ? void 0 : startTimeout();
  let response;
  try {
    if (__privateGet(this, _customRequestFn) !== void 0) {
      const result = await __privateGet(this, _customRequestFn).call(this, url, init);
...
var _httpRequest, _defaultTimeout, _defaultInterval, _applyWaitTask;
var TaskClient = class {
  constructor(httpRequest, defaultWaitOptions) {
    ...
    __privateAdd(this, _defaultInterval);
    __privateAdd(this, _applyWaitTask);
    __privateSet(this, _httpRequest, httpRequest);
    __privateSet(this, _defaultTimeout, (defaultWaitOptions == null ? void 0 : defaultWaitOptions.timeout) ?? 5e3);
    __privateSet(this, _defaultInterval, (defaultWaitOptions == null ? void 0 : defaultWaitOptions.interval) ?? 50);
    __privateSet(this, _applyWaitTask, getWaitTaskApplier(this));
  }
  /** {@link https://www.meilisearch.com/docs/reference/api/tasks#get-one-task} */
  async getTask(uid, extraRequestInit) {
    return await __privateGet(this, _httpRequest).get({
      path: `tasks/${uid}`,
      extraRequestInit
    });
  }
  ...
  async getTasks(params) {
    return await __privateGet(this, _httpRequest).get({ path: "tasks", params });
  }
  /**
  ...
  async waitForTask(taskUidOrEnqueuedTask, options) {
    ...
    const timeout = (options == null ? void 0 : options.timeout) ?? __privateGet(this, _defaultTimeout);
    const interval = (options == null ? void 0 : options.interval) ?? __privateGet(this, _defaultInterval);
    const ac = timeout > 0 ? new AbortController() : null;
    const toId = ac !== null ? setTimeout(() => void ac.abort(TIMEOUT_ID), timeout) : void 0;
    try {
      for (; ; ) {
        const task = await this.getTask(taskUid, { signal: ac == null ? void 0 : ac.signal });
  ...
  cancelTasks(params) {
    return __privateGet(this, _applyWaitTask).call(this, __privateGet(this, _httpRequest).post({ path: "tasks/cancel", params }));
  }
  /** {@link https://www.meilisearch.com/docs/reference/api/tasks#delete-tasks} */
  deleteTasks(params) {
    return __privateGet(this, _applyWaitTask).call(this, __privateGet(this, _httpRequest).delete({ path: "tasks", params }));
  }
};
_httpRequest = new WeakMap();
_defaultTimeout = new WeakMap();
_defaultInterval = new WeakMap();
_applyWaitTask = new WeakMap();
...
var Index = class {
  ...
  constructor(config, uid, primaryKey) {
    ...
    __privateAdd(this, _httpRequestsWithTask);
    this.uid = uid;
    this.primaryKey = primaryKey;
    this.httpRequest = new HttpRequests(config);
    this.tasks = new TaskClient(this.httpRequest, config.defaultWaitOptions);
    __privateSet(this, _httpRequestsWithTask, getHttpRequestsWithEnqueuedTaskPromise(
      this.httpRequest,
      this.tasks
    ));
  }
   ...
   */
  update(data) {
    return __privateGet(this, _httpRequestsWithTask).patch({
      path: `indexes/${this.uid}`,
      body: data
    });
  }
   ...
   */
  delete() {
    return __privateGet(this, _httpRequestsWithTask).delete({
      path: `indexes/${this.uid}`
    });
  }
  ///
  ...
  async getDocuments(params) {
    ...
    return (params == null ? void 0 : params.filter) !== void 0 ? (
  ...
  async getDocument(documentId, parameters) {
    const fields = Array.isArray(parameters == null ? void 0 : parameters.fields) ? parameters.fields.join() : void 0;
    return await this.httpRequest.get({
  ...
  addDocuments(documents, options) {
    return __privateGet(this, _httpRequestsWithTask).post({
  ...
  updateDocuments(documents, options) {
    return __privateGet(this, _httpRequestsWithTask).put({
      path: `indexes/${this.uid}/documents`,
      params: options,
      body: documents
    });
...
var ChatWorkspace = class {
   ...
   */
  async get() {
    return await __privateGet(this, _httpRequest3).get({
      path: `chats/${__privateGet(this, _workspace)}/settings`
    });
  }
  /**
  ...
  async update(settings) {
    return await __privateGet(this, _httpRequest3).patch({
      path: `chats/${__privateGet(this, _workspace)}/settings`,
      body: settings
    });
  }
   ...
   */
  async reset() {
    await __privateGet(this, _httpRequest3).delete({
      path: `chats/${__privateGet(this, _workspace)}/settings`
    });
  }
  /**
  ...
  async streamCompletion(completion) {
    ...
    return await __privateGet(this, _httpRequest3).postStream({
      path: `chats/${__privateGet(this, _workspace)}/chat/completions`,
      body: completion
    });
  }
};
...
var _taskClient, _batchClient, _httpRequestsWithTask2;
var MeiliSearch = class {
  ...
  constructor(config) {
    ...
    __publicField(this, "httpRequest");
    __privateAdd(this, _taskClient);
    __privateAdd(this, _batchClient);
    __privateAdd(this, _httpRequestsWithTask2);
    this.config = config;
    this.httpRequest = new HttpRequests(config);
    __privateSet(this, _taskClient, new TaskClient(
      this.httpRequest,
      config.defaultWaitOptions
    ));
    __privateSet(this, _batchClient, new BatchClient(this.httpRequest));
    __privateSet(this, _httpRequestsWithTask2, getHttpRequestsWithEnqueuedTaskPromise(
      this.httpRequest,
      this.tasks
    ));
  }
  get tasks() {
    return __privateGet(this, _taskClient);
  }
  get batches() {
    return __privateGet(this, _batchClient);
  }
  /**
  ...
  async deleteIndexIfExists(uid) {
    ...
    try {
      ...
      if (((_a = e == null ? void 0 : e.cause) == null ? void 0 : _a.code) === ErrorStatusCode.INDEX_NOT_FOUND) {
        return false;
      }
      throw e;
    }
   ...
   */
  swapIndexes(params) {
    return __privateGet(this, _httpRequestsWithTask2).post({
      path: "swap-indexes",
      body: params
    });
  }
...
_taskClient = new WeakMap();
_batchClient = new WeakMap();
_httpRequestsWithTask2 = new WeakMap();
